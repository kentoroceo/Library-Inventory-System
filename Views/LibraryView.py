...
class LibraryView(QWidget):
    def __init__(self, library_controller, issuance_controller, book_controller):
        ...
        self._ui.AddBookButton.clicked.connect(self.GoToAddBookView)
    ...
    def InitializeLibrary(self):
        ...
        for index, book in enumerate(self._allBooks):
            ...
            self._bookView.append(BookView(self._bookModel, self._book_controller, self._issuance_model, self._issuance_controller))
