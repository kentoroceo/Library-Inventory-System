...
class Ui_Library(object):
    def setupUi(self, Library):
        ...
        self.AddBookButton = QtWidgets.QPushButton(self.frame)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.horizontalLayout.addWidget(self.AddBookButton)
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 773, 371))
...
"}")
    ...
    def retranslateUi(self, Library):
        ...
        self.AddBookButton.setText(_translate("Library", "Add Book"))
