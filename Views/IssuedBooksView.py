...
from Views.IssuedBooksViewUI import Ui_IssuedBooks
...
class IssuedBooksView(QWidget):
    def __init__(self, issuance_controller, returned_controller):
        ...
        self._ui.ReturnButton.clicked.connect(self.ReturnBook)
    ...
    def ReturnBook(self):
        ...
        if buttonReply == QMessageBox.Yes:
            ...
            if okPressed and item:
                ...
                self._issuance_controller.change_issuance_id(str(self._issuance_id))
